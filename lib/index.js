...
function reqwest(opts) {

    var e = opts.error,
        s = opts.success,
        mime = opts.type === 'json' ? 'application/json' : 'text/plain';
...
Auth0.version = require('../package.json').version;
